...
import 'package:toktok/features/add_video/screens/confirm_screen.dart';
...
class AddVideoScreen extends StatelessWidget {
  ...
  recordVideo(ImageSource camera, BuildContext context) async{}
  ...
  showOptionsDialog(BuildContext context){
    return showDialog(context: context, builder: (context) => SimpleDialog(
      children: [
        ...
        SimpleDialogOption(
          onPressed: () => recordVideo(ImageSource.camera, context),
          child: Row(
            children: const[
